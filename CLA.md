...
- contributors do not provide warranties beyond the representations stated in the agreement;
- the agreement applies to accepted contributions, not unrelated work created by the contributor.
...
A pull request may be reviewed before the CLA process is complete, but an external contribution that requires the CLA will not be merged until the contributor has completed the required agreement.
