...
Security issues should be reported privately so they can be investigated and fixed before public disclosure.
...
Do not include real customer credentials, production secrets, or unnecessary personal data in a report.
